...
# )
    ...
    # SPAWN CAMERA
    topdown_camera_sdf = os.path.join(
        get_package_share_directory('ur5_ros2_gazebo'),
        'models',
        'topdown_camera.sdf'
    )

    sideview_camera_sdf = os.path.join(
        get_package_share_directory('ur5_ros2_gazebo'),
        'models',
        'sideview_camera.sdf'
    )
    
    spawn_topdown_camera = Node(
        package='ros_gz_sim',
        executable='create',
        arguments=[
            '-file', topdown_camera_sdf,
            '-name', 'topdown_camera',
            '-x', '0.5',
            '-y', '0',
            '-z', '1.5'
    ...
    spawn_sideview_camera = Node(
        package='ros_gz_sim',
        executable='create',
        arguments=[
            '-file', sideview_camera_sdf,
            '-name', 'sideview_camera',
            '-x', '0.4',
            '-y', '0.8',
            '-z', '0.1'
        ],
    ...
    return LaunchDescription([
        ...
        spawn_entity,
        spawn_topdown_camera,
        spawn_sideview_camera,
        gz_ros_bridge
    ])