...
class Init_Attacher_SendGoal_Event_response
{
public:
  explicit Init_Attacher_SendGoal_Event_response(::ros2_grasping::action::Attacher_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::ros2_grasping::action::Attacher_SendGoal_Event response(::ros2_grasping::action::Attacher_SendGoal_Event::_response_type arg)
  {
...
private:
  ::ros2_grasping::action::Attacher_SendGoal_Event msg_;
};

class Init_Attacher_SendGoal_Event_request
{
public:
  explicit Init_Attacher_SendGoal_Event_request(::ros2_grasping::action::Attacher_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_Attacher_SendGoal_Event_response request(::ros2_grasping::action::Attacher_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Attacher_SendGoal_Event_response(msg_);
  }
...
class Init_Attacher_SendGoal_Event_info
{
public:
  Init_Attacher_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Attacher_SendGoal_Event_request info(::ros2_grasping::action::Attacher_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Attacher_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::ros2_grasping::action::Attacher_SendGoal_Event>()
{
  return ros2_grasping::action::builder::Init_Attacher_SendGoal_Event_info();
}
...
class Init_Attacher_GetResult_Event_response
{
public:
  explicit Init_Attacher_GetResult_Event_response(::ros2_grasping::action::Attacher_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::ros2_grasping::action::Attacher_GetResult_Event response(::ros2_grasping::action::Attacher_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::ros2_grasping::action::Attacher_GetResult_Event msg_;
};

class Init_Attacher_GetResult_Event_request
{
public:
  explicit Init_Attacher_GetResult_Event_request(::ros2_grasping::action::Attacher_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_Attacher_GetResult_Event_response request(::ros2_grasping::action::Attacher_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Attacher_GetResult_Event_response(msg_);
  }
...
class Init_Attacher_GetResult_Event_info
{
public:
  Init_Attacher_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Attacher_GetResult_Event_request info(::ros2_grasping::action::Attacher_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Attacher_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::ros2_grasping::action::Attacher_GetResult_Event>()
{
  return ros2_grasping::action::builder::Init_Attacher_GetResult_Event_info();
}
