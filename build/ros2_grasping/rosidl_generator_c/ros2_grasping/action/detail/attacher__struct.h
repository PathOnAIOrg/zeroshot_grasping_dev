...
enum
{
  ros2_grasping__action__Attacher_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ros2_grasping__action__Attacher_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Attacher in the package ros2_grasping.
typedef struct ros2_grasping__action__Attacher_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ros2_grasping__action__Attacher_SendGoal_Request__Sequence request;
  ros2_grasping__action__Attacher_SendGoal_Response__Sequence response;
} ros2_grasping__action__Attacher_SendGoal_Event;

// Struct for a sequence of ros2_grasping__action__Attacher_SendGoal_Event.
typedef struct ros2_grasping__action__Attacher_SendGoal_Event__Sequence
{
...
enum
{
  ros2_grasping__action__Attacher_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ros2_grasping__action__Attacher_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Attacher in the package ros2_grasping.
typedef struct ros2_grasping__action__Attacher_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ros2_grasping__action__Attacher_GetResult_Request__Sequence request;
  ros2_grasping__action__Attacher_GetResult_Response__Sequence response;
} ros2_grasping__action__Attacher_GetResult_Event;

// Struct for a sequence of ros2_grasping__action__Attacher_GetResult_Event.
typedef struct ros2_grasping__action__Attacher_GetResult_Event__Sequence
{
