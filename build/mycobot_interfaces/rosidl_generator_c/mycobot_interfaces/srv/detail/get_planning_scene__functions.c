...
mycobot_interfaces__srv__GetPlanningScene_Request__create(void)
{
...
mycobot_interfaces__srv__GetPlanningScene_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
mycobot_interfaces__srv__GetPlanningScene_Event__init(mycobot_interfaces__srv__GetPlanningScene_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    mycobot_interfaces__srv__GetPlanningScene_Event__fini(msg);
    return false;
  }
  // request
  if (!mycobot_interfaces__srv__GetPlanningScene_Request__Sequence__init(&msg->request, 0)) {
    mycobot_interfaces__srv__GetPlanningScene_Event__fini(msg);
    return false;
  }
  // response
  if (!mycobot_interfaces__srv__GetPlanningScene_Response__Sequence__init(&msg->response, 0)) {
    mycobot_interfaces__srv__GetPlanningScene_Event__fini(msg);
    return false;
  }
  return true;
...
void
mycobot_interfaces__srv__GetPlanningScene_Event__fini(mycobot_interfaces__srv__GetPlanningScene_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  mycobot_interfaces__srv__GetPlanningScene_Request__Sequence__fini(&msg->request);
  // response
  mycobot_interfaces__srv__GetPlanningScene_Response__Sequence__fini(&msg->response);
}

bool
mycobot_interfaces__srv__GetPlanningScene_Event__are_equal(const mycobot_interfaces__srv__GetPlanningScene_Event * lhs, const mycobot_interfaces__srv__GetPlanningScene_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!mycobot_interfaces__srv__GetPlanningScene_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!mycobot_interfaces__srv__GetPlanningScene_Response__Sequence__are_equal(
...
bool
mycobot_interfaces__srv__GetPlanningScene_Event__copy(
  const mycobot_interfaces__srv__GetPlanningScene_Event * input,
  mycobot_interfaces__srv__GetPlanningScene_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!mycobot_interfaces__srv__GetPlanningScene_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!mycobot_interfaces__srv__GetPlanningScene_Response__Sequence__copy(
...
mycobot_interfaces__srv__GetPlanningScene_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mycobot_interfaces__srv__GetPlanningScene_Event * msg = (mycobot_interfaces__srv__GetPlanningScene_Event *)allocator.allocate(sizeof(mycobot_interfaces__srv__GetPlanningScene_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mycobot_interfaces__srv__GetPlanningScene_Event));
  bool success = mycobot_interfaces__srv__GetPlanningScene_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
mycobot_interfaces__srv__GetPlanningScene_Event__destroy(mycobot_interfaces__srv__GetPlanningScene_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    mycobot_interfaces__srv__GetPlanningScene_Event__fini(msg);
...
bool
mycobot_interfaces__srv__GetPlanningScene_Event__Sequence__init(mycobot_interfaces__srv__GetPlanningScene_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mycobot_interfaces__srv__GetPlanningScene_Event * data = NULL;

  if (size) {
    data = (mycobot_interfaces__srv__GetPlanningScene_Event *)allocator.zero_allocate(size, sizeof(mycobot_interfaces__srv__GetPlanningScene_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mycobot_interfaces__srv__GetPlanningScene_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mycobot_interfaces__srv__GetPlanningScene_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
mycobot_interfaces__srv__GetPlanningScene_Event__Sequence__fini(mycobot_interfaces__srv__GetPlanningScene_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mycobot_interfaces__srv__GetPlanningScene_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
mycobot_interfaces__srv__GetPlanningScene_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mycobot_interfaces__srv__GetPlanningScene_Event__Sequence * array = (mycobot_interfaces__srv__GetPlanningScene_Event__Sequence *)allocator.allocate(sizeof(mycobot_interfaces__srv__GetPlanningScene_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mycobot_interfaces__srv__GetPlanningScene_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
mycobot_interfaces__srv__GetPlanningScene_Event__Sequence__destroy(mycobot_interfaces__srv__GetPlanningScene_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mycobot_interfaces__srv__GetPlanningScene_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
mycobot_interfaces__srv__GetPlanningScene_Event__Sequence__are_equal(const mycobot_interfaces__srv__GetPlanningScene_Event__Sequence * lhs, const mycobot_interfaces__srv__GetPlanningScene_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mycobot_interfaces__srv__GetPlanningScene_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
mycobot_interfaces__srv__GetPlanningScene_Event__Sequence__copy(
  const mycobot_interfaces__srv__GetPlanningScene_Event__Sequence * input,
  mycobot_interfaces__srv__GetPlanningScene_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mycobot_interfaces__srv__GetPlanningScene_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mycobot_interfaces__srv__GetPlanningScene_Event * data =
      (mycobot_interfaces__srv__GetPlanningScene_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mycobot_interfaces__srv__GetPlanningScene_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mycobot_interfaces__srv__GetPlanningScene_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mycobot_interfaces__srv__GetPlanningScene_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
