...
class GetPlanningScene_Event(metaclass=Metaclass_GetPlanningScene_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<mycobot_interfaces/GetPlanningScene_Request, 1>',
        'response': 'sequence<mycobot_interfaces/GetPlanningScene_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mycobot_interfaces', 'srv'], 'GetPlanningScene_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mycobot_interfaces', 'srv'], 'GetPlanningScene_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from mycobot_interfaces.srv import GetPlanningScene_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from mycobot_interfaces.srv import GetPlanningScene_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class GetPlanningScene(metaclass=Metaclass_GetPlanningScene):
    ...
    from mycobot_interfaces.srv._get_planning_scene import GetPlanningScene_Event as Event
