...
# Import BiLerobot to register all custom environments including BiSO100OpenLid-v1
import bi_lerobot
...
def main(args: Args):
    ...
    while True:
        ...
        if step_counter >= warmup_steps:
            # First arm control - using target_joints and P control
            if keys[pygame.K_q]:
            ...
            # Second arm control - using target_joints and P control
            if keys[pygame.K_y]:
