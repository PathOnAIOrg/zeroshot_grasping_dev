...
class BiSO100Follower(Robot):
    ...
    def _get_left_calibration(self):
        ...
        left_calibration_path = Path("/home/zhiyuan/.cache/huggingface/lerobot/calibration/robots/so100_follower") / f"{self.config.left_id}.json"
    ...
    def _get_right_calibration(self):
        ...
        right_calibration_path = Path("/home/zhiyuan/.cache/huggingface/lerobot/calibration/robots/so100_follower") / f"{self.config.right_id}.json"
    ...
    def calibrate(self) -> None:
        ...
        if left_calibration is None:
            raise ValueError(f"No calibration found for left arm (ID: {self.config.left_id}). "
                           "Please ensure calibration exists at /home/zhiyuan/.cache/huggingface/lerobot/calibration/robots/so100_follower/")
