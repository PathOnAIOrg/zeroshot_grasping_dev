...
bool mycobot_interfaces__srv__get_planning_scene__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mycobot_interfaces.srv._get_planning_scene.GetPlanningScene_Request", full_classname_dest, 67) == 0);
  }
  mycobot_interfaces__srv__GetPlanningScene_Request * ros_message = _ros_message;
  {  // target_shape
...
PyObject * mycobot_interfaces__srv__get_planning_scene__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mycobot_interfaces.srv._get_planning_scene");
...
ROSIDL_GENERATOR_C_EXPORT
bool mycobot_interfaces__srv__get_planning_scene__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mycobot_interfaces.srv._get_planning_scene.GetPlanningScene_Response", full_classname_dest, 68) == 0);
  }
  mycobot_interfaces__srv__GetPlanningScene_Response * ros_message = _ros_message;
  {  // scene_world
...
ROSIDL_GENERATOR_C_EXPORT
bool mycobot_interfaces__srv__get_planning_scene__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mycobot_interfaces.srv._get_planning_scene.GetPlanningScene_Event", full_classname_dest, 65) == 0);
  }
  mycobot_interfaces__srv__GetPlanningScene_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!mycobot_interfaces__srv__GetPlanningScene_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create mycobot_interfaces__srv__GetPlanningScene_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    mycobot_interfaces__srv__GetPlanningScene_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!mycobot_interfaces__srv__get_planning_scene__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!mycobot_interfaces__srv__GetPlanningScene_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create mycobot_interfaces__srv__GetPlanningScene_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    mycobot_interfaces__srv__GetPlanningScene_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!mycobot_interfaces__srv__get_planning_scene__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * mycobot_interfaces__srv__get_planning_scene__event__convert_to_py(void * raw_ros_message)
{
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = mycobot_interfaces__srv__get_planning_scene__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = mycobot_interfaces__srv__get_planning_scene__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
