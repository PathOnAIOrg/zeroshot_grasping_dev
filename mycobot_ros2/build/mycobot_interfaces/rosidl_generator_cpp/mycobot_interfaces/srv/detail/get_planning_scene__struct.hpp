...
// IWYU pragma: private, include "mycobot_interfaces/srv/get_planning_scene.hpp"
...
#ifndef _WIN32
# define DEPRECATED__mycobot_interfaces__srv__GetPlanningScene_Event __attribute__((deprecated))
#else
# define DEPRECATED__mycobot_interfaces__srv__GetPlanningScene_Event __declspec(deprecated)
#endif
...
struct GetPlanningScene_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<mycobot_interfaces::srv::GetPlanningScene_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<mycobot_interfaces::srv::GetPlanningScene_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<mycobot_interfaces::srv::GetPlanningScene_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<mycobot_interfaces::srv::GetPlanningScene_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<mycobot_interfaces::srv::GetPlanningScene_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<mycobot_interfaces::srv::GetPlanningScene_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<mycobot_interfaces::srv::GetPlanningScene_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<mycobot_interfaces::srv::GetPlanningScene_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    mycobot_interfaces::srv::GetPlanningScene_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const mycobot_interfaces::srv::GetPlanningScene_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<mycobot_interfaces::srv::GetPlanningScene_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<mycobot_interfaces::srv::GetPlanningScene_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      mycobot_interfaces::srv::GetPlanningScene_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<mycobot_interfaces::srv::GetPlanningScene_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      mycobot_interfaces::srv::GetPlanningScene_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<mycobot_interfaces::srv::GetPlanningScene_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<mycobot_interfaces::srv::GetPlanningScene_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<mycobot_interfaces::srv::GetPlanningScene_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__mycobot_interfaces__srv__GetPlanningScene_Event
    std::shared_ptr<mycobot_interfaces::srv::GetPlanningScene_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__mycobot_interfaces__srv__GetPlanningScene_Event
    std::shared_ptr<mycobot_interfaces::srv::GetPlanningScene_Event_<ContainerAllocator> const>
...
using GetPlanningScene_Event =
  mycobot_interfaces::srv::GetPlanningScene_Event_<std::allocator<void>>;
...
struct GetPlanningScene
{
  ...
  using Event = mycobot_interfaces::srv::GetPlanningScene_Event;
};
