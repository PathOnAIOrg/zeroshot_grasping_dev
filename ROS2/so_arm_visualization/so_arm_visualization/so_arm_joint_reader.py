...
class SOArmJointReader(Node):
    def __init__(self):
        ...
        self.get_logger().info("🚀 SO-ARM101 Hardware Driver started - publishing to /joint_states at 20Hz")
        self.get_logger().info("✅ Direct hardware interface - reads from physical robot")
        self.get_logger().info("🔄 IK teleoperation support - publishing to /robot/cmd_pose")
